...
import {faComment, faFolder, faLock, faNewspaper, faSignOutAlt, faUser} from '@fortawesome/free-solid-svg-icons'


library.add(faLock, faNewspaper, faFolder, faComment, faSignOutAlt, faUser)
