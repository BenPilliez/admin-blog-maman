...
import {faComment, faFolder, faLock, faNewspaper, faSignOutAlt, faUser, faTrash} from '@fortawesome/free-solid-svg-icons'


library.add(faLock, faNewspaper, faFolder, faComment, faSignOutAlt, faUser, faTrash)
